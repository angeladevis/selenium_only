...
# Модуль 2, раздел 2, 6 степ (2_1_5) методом Keys
'''
from selenium import webdriver
from selenium.webdriver.common.by import By
from selenium.webdriver.common.keys import Keys #здесь эту строку добавляем
import math, time
...
browser.find_element(By.TAG_NAME, 'body').send_keys(Keys.END) #4-й вариант или Home если наверх
